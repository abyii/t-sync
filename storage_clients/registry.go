...
type UploaderFactory func(bucket, object, authType, namespace string) (any, error)
...
func GetUploader(provider, bucket, object, authType, namespace string) (any, error) {
